...
const ROUTE_READINESS = {
  ...
  '/gsoc/community': { selector: 'h1, main', timeout: 15000 },
  '/gsoc/blog': { selector: 'h1, main', timeout: 15000 },
...
const ALL_ROUTES = [
  ...
  { path: '/gsoc/community', name: 'gsoc-community' },
  { path: '/gsoc/blog', name: 'gsoc-blog' },
